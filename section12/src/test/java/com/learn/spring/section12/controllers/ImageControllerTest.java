...
import com.learn.spring.section12.service.ImageService;
...
class ImageControllerTest {
    ...
    public void handleImagePost() throws Exception{
        MockMultipartFile multipartFile =
                new MockMultipartFile("imagefile", "testing.txt", "text/plain", "Spring Framework Guru".getBytes(StandardCharsets.UTF_8));
    ...
    public void renderImageFromDB() throws Exception{
        ...
        for(byte primeByte : s.getBytes(StandardCharsets.UTF_8)){

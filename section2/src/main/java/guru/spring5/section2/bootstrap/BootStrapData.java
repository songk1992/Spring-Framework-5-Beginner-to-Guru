package guru.spring5.section2.bootstrap;
...
import guru.spring5.section2.repositories.BookRepository;
import guru.spring5.section2.repositories.PublisherRepository;
...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args){
        ...
        publisher.setName("Spring Boot Publishing");
        publisher.setCity("City Name");
        publisher.setState("CN");
